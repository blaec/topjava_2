...
<div class="jumbotron">
    <div class="container">
        ...
        <br/>
        <p><spring:message code="app.login.tech"/><a href="http://projects.spring.io/spring-security/">Spring Security</a>,
...
<div class="container">
    <div class="lead">
        &nbsp;&nbsp;&nbsp;<a href="https://github.com/JavaOPs/topjava">Java Enterprise<spring:message code="app.login.project"/></a>
        <spring:message code="app.login.description"/>
    </div>
</div>
