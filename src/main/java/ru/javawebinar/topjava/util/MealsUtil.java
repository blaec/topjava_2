...
public class MealsUtil {
    public static final List<Meal> USER_MEALS = Arrays.asList(
            new Meal(LocalDateTime.of(2018, Month.JANUARY, 30, 10, 0), "Завтрак", 500),
            new Meal(LocalDateTime.of(2018, Month.JANUARY, 30, 13, 0), "Обед", 1000),
            new Meal(LocalDateTime.of(2018, Month.JANUARY, 30, 20, 0), "Ужин", 500),
            new Meal(LocalDateTime.of(2018, Month.JANUARY, 31, 10, 0), "Завтрак", 1000),
            new Meal(LocalDateTime.of(2018, Month.JANUARY, 31, 13, 0), "Обед", 500),
            new Meal(LocalDateTime.of(2018, Month.JANUARY, 31, 20, 0), "Ужин", 510)
    );

    public static final List<Meal> ADMIN_MEALS = Arrays.asList(
            new Meal(LocalDateTime.of(2018, Month.JANUARY, 30, 10, 0), "Админ-Завтрак", 7500),
            new Meal(LocalDateTime.of(2018, Month.JANUARY, 30, 13, 0), "Админ-Обед", 1250)
    );
